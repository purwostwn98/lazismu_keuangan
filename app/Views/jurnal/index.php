...
<?= $this->section('styles') ?>
<style>
    .badge-penerimaan  { background: #198754; }
    .badge-penyaluran  { background: #0d6efd; }
    .badge-biaya       { background: #fd7e14; }
    .badge-transfer    { background: #6f42c1; }
    .badge-jurnal_umum { background: #6c757d; }
    .badge-piutang     { background: #20c997; }
    ...
    .jurnal-header:hover td { background: #f0f4ff !important; }
                ...
                <table class="table table-sm table-bordered mb-0" style="font-size:.82rem;">
                    ...
                    <?php else: ?>
                        <?php foreach ($jurnalList as $idx => $j):
                            ...
                            $canDelete = in_array($j['jenis_transaksi'], ['biaya', 'jurnal_umum']) && !$j['is_tutup'];
                            $rowId     = 'det-' . $j['id'];
                        ?>
...
document.querySelectorAll('.jurnal-header').forEach(function (row) {
    ...
    detail.addEventListener('show.bs.collapse',  function () { icon.style.transform = 'rotate(0deg)'; });
    detail.addEventListener('hide.bs.collapse',  function () { icon.style.transform = 'rotate(-90deg)'; });
