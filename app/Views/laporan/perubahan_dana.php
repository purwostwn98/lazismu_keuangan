...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-start mb-3">
        <div>
            <h4 class="mb-0 fw-bold">Laporan Perubahan Dana</h4>
            <small class="text-muted">Penerimaan, Penyaluran, Surplus/Defisit per Jenis Dana — LAZISMU UMS</small>
        </div>
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-3 text-center">
            ...
            <div class="fw-bold fs-6 mt-1">LAPORAN PERUBAHAN DANA</div>
    ...
    <div class="text-muted small mt-2 px-1">
        ...
        Angka dalam kurung <span class="text-danger fw-semibold">(xxx)</span> menunjukkan defisit / penurunan dana.
        Saldo dana dihitung kumulatif dari awal tahun.
    </div>
